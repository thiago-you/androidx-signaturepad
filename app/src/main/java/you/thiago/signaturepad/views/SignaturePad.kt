...
import you.thiago.signaturepad.utils.TimedPoint
...
class SignaturePad(context: Context, attrs: AttributeSet?) : View(context, attrs) {
    ...
    init {
        ...
        try {
            ...
            mPaint.color = a.getColor(
                ...
                ContextCompat.getColor(context, R.color.pen_color)
            )
     ...
     */
    private fun Resources.getFloatDimension(dimensResourceId: Int): Float {
     ...
     * Will return 12
     */
    private fun Resources.getDimensionInDp(dimensResourceId: Int): Int {
